		...
		<div class="calendarWrap">
			...
			<div class="calendarContent">
				<ul class="calendarUl">
					...
					<li><a href="#">19 Мая - День медработника</a></li>
					<li><a href="#">22 Мая - Выставка работ</a></li>
					<li><a href="#">25 Мая - Летний лагерь</a></li>
					<li><a href="#">7 Июня - День открытых дверей</a></li>
					<li><a href="#">15 Мая - День птиц</a></li>
					<li><a href="#">19 Мая - День медработника</a></li>
					<li><a href="#">22 Мая - Выставка работ</a></li>
					<li><a href="#">25 Мая - Летний лагерь</a></li>
